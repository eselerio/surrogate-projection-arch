...
\midrule
\csvrowssix{table_s_dataset_validation.csv}
\bottomrule
\end{tabular}
\end{table}
...
\csvlongtable
  ...
  {table_s_id_component_accuracy.csv}
  {\csvrowseight}
\endgroup
...
\csvlongtable
  ...
  {table_s_id_composite_accuracy.csv}
  {\csvrowsseven}
\endgroup
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.96\textwidth]{figure_training_time_scaling.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.94\textwidth]{figure_inference_latency.pdf}
...
\csvlongtable
  ...
  {8}
  {Component & Unit & Surrogate & Raw nRMSE$_j$ & Projected nRMSE$_j$ & $\Delta$nRMSE$_j$ & Raw $R^2_j$ & Projected $R^2_j$}
  {table_s_ood_mild_component_accuracy.csv}
  {\csvrowseight}
\endgroup
...
\csvlongtable
  ...
  {7}
  {Composite & Surrogate & Raw nRMSE$_q$ & Projected nRMSE$_q$ & $\Delta$nRMSE$_q$ & Raw $R^2$ & Projected $R^2$}
  {table_s_ood_mild_composite_accuracy.csv}
  {\csvrowsseven}
\endgroup
...
\csvlongtable
  ...
  {8}
  {Component & Unit & Surrogate & Raw nRMSE$_j$ & Projected nRMSE$_j$ & $\Delta$nRMSE$_j$ & Raw $R^2_j$ & Projected $R^2_j$}
  {table_s_ood_severe_component_accuracy.csv}
  {\csvrowseight}
\endgroup
...
\csvlongtable
  ...
  {7}
  {Composite & Surrogate & Raw nRMSE$_q$ & Projected nRMSE$_q$ & $\Delta$nRMSE$_q$ & Raw $R^2$ & Projected $R^2$}
  {table_s_ood_severe_composite_accuracy.csv}
  {\csvrowsseven}
\endgroup
...
\csvlongtable
  ...
  {table_s_full_hyperparameters.csv}
  {\csvrowstwo}
\endgroup
